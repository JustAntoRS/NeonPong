...
doesn't provide with a loading screen because the loadings are almost 
instant, to see how to produce loading screens and a better loading
method see:
...
func load_scene(path : String) -> void: #path must be the absolute location of the scene
